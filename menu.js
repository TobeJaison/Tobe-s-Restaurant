            ...
            if (foodItem == "Sandwiches") {
                if (isNaN(amount) != true) {
                    ...
                    for (var i = 0; i < orderArr.length; i++) {
                        if (orderArr[i] != sandwichArr[index]) {
                            continue;
                        }
                        else {
                            alert(sandwichArr[index].title + " has already been added to your order");
                ...
                if (isNaN(amount) != true) {
                    ...
                    for (var i = 0; i < orderArr.length; i++) {
                        if (orderArr[i] != saladArr[index]) {
                            continue;
                        }
                        else {
                            alert(saladArr[index].title + " has already been added to your order");
                ...
                if (isNaN(amount) != true) {
                    ...
                    for (var i = 0; i < orderArr.length; i++) {
                        if (orderArr[i] != pizzaArr[index]) {
                            continue;
                        }
                        else {
                            alert(pizzaArr[index].title + " has already been added to your order");
                ...
                if (isNaN(amount) != true) {
                    ...
                    for (var i = 0; i < orderArr.length; i++) {
                        if (orderArr[i] != sodaArr[index]) {
                            continue;
                        }
                        else {
                            alert(sodaArr[index].title + " has already been added to your order");
